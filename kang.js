...
const h1 = function() {
    return kangUI('h1').css("font-family", "baloo");
}
const h2 = function() {
    return kangUI('h2').css("fontFamily", "arima");
}
const h3 = function() {
    return kangUI('h3');
}
...
const option = function() {
    return kangUI('option');
}
const textarea = function() {
    return kangUI('textarea');
}
